...
* change GPIO direction as described in the C2 interface specification. In order to prevent both Raspberry Pi and MCU from driving the DATA line at the same time.
